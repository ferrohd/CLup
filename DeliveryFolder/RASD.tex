...
\item
  ...
  \item
    ...
    \end{itemize}
  \item
    \protect\hyperlink{d-assumptions-dependecies-and-constraints}{D.
    Assumptions, dependecies and constraints}
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      \protect\hyperlink{e1-reliability-and-avaiability}{E.1.
      Reliability and avaiability}
    \item
...
\begin{figure}
\centering
\includegraphics{assets/use/../class_diagram/class_diagram_rasd.svg}
...
\begin{figure}
\centering
\includegraphics{assets/use/../state_diagrams/ticket_state.svg}
...
\begin{figure}
\centering
\includegraphics{assets/use/../state_diagrams/store_state.svg}
\caption{Store state}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/use/../state_diagrams/time_slot_state.svg}
...
\begin{figure}
\centering
\includegraphics{assets/use/../use_cases/use_case_visitor_registration.svg}
\caption{Visitor}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/use/../use_cases/use_case_user.svg}
\caption{User}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/use/../use_cases/use_case_store_manager.svg}
...
\begin{figure}
\centering
\includegraphics{assets/use/../sequence_diagrams/sequence_diagram_visitor_registration.svg}
...
\begin{figure}
\centering
\includegraphics{assets/use/../sequence_diagrams/sequence_diagram_user_login.svg}
\caption{User Login}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/use/../sequence_diagrams/sequence_diagram_user_queue_up.svg}
...
\begin{figure}
\centering
\includegraphics{assets/use/../sequence_diagrams/sequence_diagram_user_leave_queue.svg}
...
\begin{figure}
\centering
\includegraphics{assets/use/../sequence_diagrams/sequence_diagram_user_booking.svg}
...
\begin{figure}
\centering
\includegraphics{assets/use/../sequence_diagrams/sequence_diagram_user_cancel_booking.svg}
...
\begin{figure}
\centering
\includegraphics{assets/use/../sequence_diagrams/sequence_diagram_store_manager_issue_ticket.svg}
...
\begin{figure}
\centering
\includegraphics{assets/use/../sequence_diagrams/sequence_diagram_store_manager_scan_ticket.svg}
...
\begin{figure}
\centering
\includegraphics{assets/use/../alloy/execution_result.png}
...
\begin{figure}
\centering
\includegraphics{assets/use/../alloy/world_1.png}
\caption{World 1}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/use/../alloy/world_2.png}
\caption{World 2}
\end{figure}
